...
open class Rokahon(override val lang: String, private val siteLang: String, private val latestLang: String) : ParsedHttpSource() {

    // Basic Info
    override val name = "Rokahon"
    final override val baseUrl = "http://rokahon.local"
